...
class DistrictSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $zone_pantai_barat_selatan = Zone::where('name', "Zon Pantai Barat Selatan")->first();
        $zone_pantai_barat_utara = Zone::where('name', "Zon Pantai Barat Utara")->first();
        $zone_pedalaman_atas = Zone::where('name', "Zon Pedalaman Atas")->first();
        $zone_pedalaman_bawah = Zone::where('name', "Zon Pedalaman Bawah")->first();
        $zone_sandakan = Zone::where('name', "Zon Sandakan")->first();
        $zone_tawau = Zone::where('name', "Zon Tawau")->first();
