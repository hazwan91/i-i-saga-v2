...
class SagaSportEventContingentRole extends Model
{
    /** @use HasFactory<\Database\Factories\SagaSportEventContingentRoleFactory> */
    use HasFactory;
    ...
    protected static function booted()
    {
        static::addGlobalScope('currentSaga', function (Builder $builder) {
            $builder->whereHas('sagaSportContingentRole', function ($query) {
    ...
    public function sagaSportContingentRole()
    {
        return $this->belongsTo(SagaSportContingentRole::class);
    }
