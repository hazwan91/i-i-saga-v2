...
class SagaRegistrationContingent extends Model
{
    /** @use HasFactory<\Database\Factories\SagaRegistrationContingentFactory> */
    use HasFactory;
    ...
    public function sagaRegistrationContingentRecords()
    {
        return $this->hasMany(SagaRegistrationContingentRecord::class);
    }
}
