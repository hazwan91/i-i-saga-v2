<template>
    ...
    <q-layout view="hHh Lpr fFf" class="bg-slate-200">
        <q-header class="text-grey-8 q-py-xs bg-white shadow-md" height-hint="58">
            <q-toolbar>
                <q-btn flat dense round @click="toggleLeftDrawer" aria-label="Menu" icon="mdi-menu" />

                <q-btn flat no-caps no-wrap class="q-ml-xs" v-if="$q.screen.gt.xs" :href="route('auth.home.index')"
                    @click.prevent="router.get(route('auth.home.index'))">
                    ...
                    <q-toolbar-title shrink class="text-weight-bold text-xl">
                        I-SAGA <span class="text-[14px] text-amber-500">v2</span>
                    </q-toolbar-title>
                </q-btn>
                ...
                <div class="q-gutter-sm row no-wrap items-center">
                    ...
                    <q-btn-dropdown flat icon="mdi-account">
                        <q-list>
                            <q-item clickable v-close-popup @click.prevent="router.delete(route('auth.logout'))">
...
<slot name="breadcrumbs" />
        ...
        <q-drawer v-model="leftDrawerOpen" show-if-above bordered class="bg-white" :width="240">
            <q-scroll-area class="fit">
                <q-list padding>
                    <q-item v-ripple clickable :active="route().current('auth.home.*')" :href="route('auth.home.index')"
                        @click.prevent="router.get(route('auth.home.index'))">
                        <q-item-section avatar>
                    ...
                    <q-item-label header class="text-weight-bold text-uppercase"> Dashboard </q-item-label>
                    ...
                    <q-item-label header class="text-weight-bold text-uppercase"> Pendaftaran </q-item-label>
                    ...
                    <q-item-label header class="text-weight-bold text-uppercase"> Admin </q-item-label>
        ...
        <q-page-container>
            <div class="scrollable-container space-y-10 px-3 pt-6 pb-20 sm:px-10">
                ...
                <div class="flex justify-center">
                    <span class="text-gray-500">&copy; 2025 HakCipta Terpelihara; Majlis Sukan Negeri Sabah</span>
                </div>
            </div>
        </q-page-container>
    </q-layout>
