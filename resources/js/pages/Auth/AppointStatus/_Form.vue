    ...
    <q-dialog ref="dialogRef" @hide="onDialogHide" @before-show="onDialogShow">
        ...
        >
            <div class="text-h6 q-mb-md">
                {{
                    operation === 'create'
                        ? 'Tambah Taraf Lantikan'
                        : 'Kemaskini Taraf Lantikan'
                }}
            </div>
            ...
            >
                <q-input
                    ...
                    placeholder="Masukkan kod taraf lantikan"
                ...
                <q-input
                    ...
                    placeholder="Masukkan nama taraf lantikan"
...
const store = () => {
    form.post('/admin/taraf-lantikan', {
        onSuccess: (res) => {
            onDialogOK();
        },
    });
...
const update = () => {
    form.put(`/admin/taraf-lantikan/${props.row.id}`, {
        onSuccess: (res) => {
            onDialogOK();
        },
    });
